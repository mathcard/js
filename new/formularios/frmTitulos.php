...
setcookie("op2");
require "modelo.php"; 
echo "<div align='center'><h2>Títulos a Receber<br><br></h2></div>";
?>
<html>
<body>
 <div style="margin-left:33%;padding:1px 0">
       <!-- <div class="logo">Titulos a Receber</div>
        <!-- Main Form -->
        <div class="panel-group">
            <form id="login-form" class="text-left" method="post" action="listarTitulos.php">
