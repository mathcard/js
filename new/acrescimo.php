...
?>
    ...
    <div class="login-form-1">
            <form id="login-form" class="text-left" action="acrescimo.php" method="get">
    ...
    <div class='table-responsive col-md-12'>
        <table class='table table-striped'>
            <thead>
                <tr>
<?php
					echo "<th><a href='acrescimo.php?ordem=num{$pnome}'>Numero do Contrato</a></th>
						  <th><a href='acrescimo.php?ordem=nome{$pnome}'>Nome do Cliente</a></th>
						  <th><a href='acrescimo.php?ordem=ass{$pnome}'>Data Ass.</a></th>
						  <th><a href='acrescimo.php?ordem=ev{$pnome}'>Data Evento</a></th>
						  <th><a href='acrescimo.php?ordem=valor{$pnome}'>Valor</a></th>
						  <th><a href='acrescimo.php?ordem=sit{$pnome}'>Acrescentar</a></th>";
?>
                </tr>
            </thead>
    </div>
...
<?php                  
	if(!empty($_GET['nome'])){
        ...
        $resultado->execute();
            ...
            while ($row = $resultado->fetchObject()) {
				...
				echo "<td><a href='frmAcrescimo.php?id=$contrato'>
                       <input type='button' name='insert' value='Acrescentar' />
                       </a></td>";				
                echo "</tr>";
                    }
            ?>
    ...
    <div class="etc-login-form">
		...
		<a href="acrescimo.php?apaga=1">Listar novamente</a>		
    </div>
